...
export const ourWork = [
  {
    ...
    projectDescription:
      'We can build a custom website for you from the ground up. We use the latest technologies to ensure lightning-fast page load times and a responsive, mobile-friendly website. We also offer ongoing, as needed maintenance.',
  },
  // {
