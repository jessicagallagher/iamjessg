        ...
        <>
          <div className='max-w-full mx-auto px-4 px-6 lg:px-8 mt-4'>
            <div className='flex justify-between h-16'>
              <div className='flex'>
                <div
                  className='flex-shrink-0 flex items-center px-4 sm:px-1 lg:px-5 xl:px-0'
                  ref={ref}
                >
                  <animated.div
                  ...
                  >
                    <Link href='/'>
                      <a>
                        <h1 className='font-raleway text-3xl sm:text-2xl lg:text-5xl text-green-default font-bold'>
                          &lt;Jessica /&gt;
                        </h1>
                      </a>
                    </Link>
              ...
              <div className='hidden sm:ml-6 sm:flex sm:space-x-4 md:space-x-8'>
                <Link href='/'>
                  <a
                    className={
                      router.pathname == '/'
                        ? 'border-pink-default text-black-900 hover:border-pink-light inline-flex items-center pt-1 border-b-2 text-md font-medium'
                        : 'border-transparent text-black-900 hover:border-pink-light inline-flex items-center pt-1 border-b-2 text-md font-medium'
                    }
                  >
                    Home
                  </a>
                ...
                <Link href='mailto:jess@iamjessg.com'>
                  <a className='border-transparent text-black-900 hover:border-pink-light inline-flex items-center pt-1 border-b-2 text-md font-medium'>
                    Contact
                  </a>
                </Link>
                <Link href='https://github.com/jessicagallagher'>
                  <a
                    target='_blank'
                    rel='noopener'
                    className='inline-flex items-center pt-1 text-md'
                  >
                    <svg
                ...
                <Link href='https://www.linkedin.com/in/jessica-gallagher/'>
                  <a
                    target='_blank'
                    rel='noopener'
                    className='inline-flex items-center pt-1 text-md'
                ...
                <Link href='https://www.instagram.com/techmeowt/'>
                  <a
                    target='_blank'
                    rel='noopener'
                    className='inline-flex items-center pt-1 text-md'
              ...
              <div className='-mr-2 flex items-center sm:hidden'>
                {/* Mobile menu button */}
                <Disclosure.Button className='inline-flex items-center justify-center p-2 rounded-md text-black-400 hover:text-black-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-green-default'>
            ...
            <div className='pt-2 pb-3 space-y-1 ml-3'>
              <Link href='/'>
                <a
                  className={
                    router.pathname == '/'
                      ? 'border-pink-default text-black-900 block pl-3 pr-4 py-2 border-l-4 text-md font-medium'
                      : 'border-transparent text-black-900 hover:border-pink-light block pl-3 pr-4 py-2 border-l-4 text-md font-medium'
                  }
                >
                  Home
                </a>
