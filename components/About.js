export default function About() {
  return (
    <div className='max-w-7xl px-4 mx-auto sm:px-6 lg:px-8 mt-4'>
      <div className='bg-pink-light overflow-hidden shadow sm:rounded-lg mt-28 z-20'>
        <div className='px-4 py-5 sm:p-6 flex flex-row'>
          <div className='align-middle'>
              <h1 className='font-lato font-bold text-black text-6xl align-middle'>About Me</h1>
            </div>
            
            <img className='h-40 w-40 rounded-sm xl:w-1/3 xl:h-1/3 align-middle' src='./images/jessica.jpg' alt='cartoon jessica' />
        </div>
