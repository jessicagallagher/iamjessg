...
import { nav, committees } from '../../../utils/crm-data';
...
export default function CrmHome() {
  // this needs to be fixed using css classes instead
  ...
  return (
    <div className='max-w-full mx-auto mt-4 sm:mt-10 lg:mt-20 bg-white'>
      <div className='min-h-full'>
        ...
        {/* desktop menu */}
        <div className='hidden lg:flex lg:w-64 lg:flex-col lg:border-r lg:border-gray-200 lg:bg-gray-100 lg:pt-5 lg:pb-4'>
