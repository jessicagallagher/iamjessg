...
export default function About() {
  return (
    <div className='max-w-full mx-auto mt-4 sm:mt-10 lg:mt-20 lg:px-10 xl:px-48'>
      <div>
        <div className='hero-about flex justify-center items-center md:relative'></div>
      </div>
      <div className='mx-auto max-w-full px-10 my-16'>
        <h1 className='text-5xl text-center font-bold'>About Us</h1>
        <br />
        <p className='text-base md:text-lg'>
          Tech Meowt works with small to mid-size non-profits to assess and
              ...
              <div className='space-y-4'>
                ...
                <div className='space-y-2'>
                  <div className='text-lg font-medium'>
                    <Link legacyBehavior href='/about/jessica-gallagher'>
                      <a className='hover:text-greenDefault hover:font-bold hover:text-2xl'>
